...
| Portfolio Frontend Dashboard | Deploy-ready | Dashboard now works locally and from a repository subpath, with project summaries, assets, live CSV outputs, and export workflow | Publish through GitHub Pages after final QA and screenshot export |
| Public Portfolio Deployment | Ready to enable | GitHub Pages workflow, `.nojekyll`, launch checklist, and deployment guide are in place | Enable Pages in repo settings and confirm the public URL |
